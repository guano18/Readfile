...
public class Dishwasher extends SemiShiftingAppliance  {
     ...
     *
     */
    protected String agentID = "Dishwasher " + (agentIDCounter++)
    ...
    public def initialize(HashMap hm) {
        ...
        createWeeklyOperationVector((int)(times + getMemberOf().getMembers().size()))
        // Return the results.
        return returnValue
    ...
    public def refresh() {
        ...
        // This is a task.
        createWeeklyOperationVector((int)( + getMemberOf().getMembers().size()))
        fillWeeklyFunction()
